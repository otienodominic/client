  ...
  useEffect(() => {
    async function fetchData() {
      ...
      const response = await fetch(
        `https://server-ujv4.onrender.com/record/${params.id.toString()}`
      );
      if (!response.ok) {
  ...
  async function onSubmit(e) {
    ...
    try {
      ...
      if (isNew) {
        ...
        response = await fetch("https://server-ujv4.onrender.com/record", {
          method: "POST",
          headers: {
        ...
        response = await fetch(`https://server-ujv4.onrender.com/record/${params.id}`, {
          method: "PATCH",
          headers: {
            "Content-Type": "application/json",
          },
